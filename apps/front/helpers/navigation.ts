...
export const userNavigation = [
  { name: 'Your Profile', href: '/profile', private: true, class: 'text-white bg-indigo-500 hover:bg-opacity-75' },
  { name: 'Sign out', href: '/logout', private: true, class: 'text-white bg-indigo-500 hover:bg-opacity-75' },
